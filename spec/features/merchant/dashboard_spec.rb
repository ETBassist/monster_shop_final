...
RSpec.describe 'Merchant Dashboard' do
  describe 'As an employee of a merchant' do
    before :each do
      ...
      OrderAddress.create!(order_id: @order_2.id, address_id: @address1.id)
      OrderAddress.create!(order_id: @order_3.id, address_id: @address1.id)
    ...
    it 'I see a link that takes me to a bulk discounts index' do
      visit '/merchant'
